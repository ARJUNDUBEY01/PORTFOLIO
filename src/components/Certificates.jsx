...
export default function Certificates() {
  return (
    <section id="certificates" className="relative py-24 md:py-40 bg-[#080808] font-['DM_Sans',sans-serif] flex flex-col items-center">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80vw] h-[80vw] bg-[radial-gradient(circle,rgba(230,60,47,0.08)_0%,rgba(0,0,0,0)_70%)] blur-[80px] z-0 pointer-events-none overflow-hidden"></div>
