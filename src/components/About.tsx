      ...
      <div style={{ position: "sticky", top: 0, height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", width: "100%" }} className="px-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-[80px] max-w-[1280px] mx-auto w-full items-center">
          ...
          <div>
            ...
            <h2 style={{ fontFamily: "'Bebas Neue', cursive", fontSize: "clamp(40px,6vw,80px)", color: "#fff", lineHeight: 0.95, marginBottom: 28 }}>Building digital<br/>experiences<br/><span style={{ WebkitTextStroke: "1px rgba(255,255,255,0.4)", color: "transparent" }}>that matter.</span></h2>
          ...
          <div style={{ position: "relative", height: "100%", width: "100%", display: "flex", justifyContent: "flex-end", alignItems: "flex-end", zIndex: 10 }} className="hidden md:flex">
            <motion.img 
              src="/arjun-new.jpg"
